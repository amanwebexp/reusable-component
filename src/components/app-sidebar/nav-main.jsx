"use client";
// This ensures the component runs on the client side (needed for hooks like useState, useEffect, etc.)
import {
  Collapsible,
  CollapsibleContent,
  CollapsibleTrigger,
...
export default function NavMain({ homeItem, items }) {
  ...
  // Utility: Check if the given URL is active
  ...
  // Utility: Check if parent section should be active/open
