...
/**
 * Main component that renders the Card demo with code examples and preview.
 */
...
const CardCode = () => {
  ...
  /**
   * Handles copying the card code snippet to the clipboard.
   */
  ...
  /**
   * Handles copying the Card component call code to the clipboard.
   */
