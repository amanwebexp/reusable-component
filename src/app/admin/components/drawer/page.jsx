...
import DrawerComponent, {
  DrawerCode,
} from "@/components/UiComponents/DrawerComponent";
 ...
 * Displays Drawer preview, code example, and installation command in a card layout.
 */
const Drawer = () => {
  ...
  /**
   * Handles copying the Drawer component code snippet to the clipboard.
   */
  ...
  /**
   * Handles copying the installation command to the clipboard.
   */
  ...
  // Tabs configuration for Preview and Code views
  const tabsItem = [
    {
  ...
  // Main card definition (description, content, extra actions)
  const mainCard = {
    // title: "Tool Tip",
    description:
