...
const TabAction = () => {
  ...
  //  Tabs items to switch between Account and Password cards
  const tabsItem = [
    {
  ...
  // Copy Tabs component call to clipboard
  ...
  // Tabs inside TabsDemo for preview, code, and component call
  const copyTabsItem = [
    {
  ...
  // Main card containing description, TabsDemo, and install command
  const tabsExample = {
    description:
