...
const Accordian = () => {
  // State variables to track clipboard copy actions for different sections:
  ...
  // Copies accordion code snippet to clipboard
  ...
  // Copies accordion component usage code
  ...
  // Accordion data (title + content for each section)
