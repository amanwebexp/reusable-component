 ...
 * -----------------------------------------
 * Renders documentation for the Sidebar component with:
 * - Code snippets for sidebar, nav-main, and nav-user
 * - Layout usage example
 * - Copy-to-clipboard functionality with toast feedback
 * - Install command for shadcn sidebar
 */
const SideBarDemo = () => {
  const [copiedId, setCopiedId] = useState(null);
  const [copiedCommand, setCopiedCommand] = useState(false);

  // Install command for sidebar component
  const commandInstall = `npx shadcn@latest add sidebar`;

  // Copy a specific code snippet to clipboard and show toast
  ...
  //  Tabs content: separate code snippets and component call
  const tabsItem = [
    {
      triggerTitle: "Code",
      value: "code",
  ...
  // Card component holding tabs and install command
  const mainCard = {
    description:
