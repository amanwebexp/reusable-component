...
// Code snippet for copy-to-clipboard functionality
...
const ToasterMessage = () => {
  ...
  // Install command for Sonner toast
  const commandInstall = `npx shadcn@latest add sonner`;

  // Copy the ToolTipCode snippet to clipboard
  ...
  // Main card displaying the tabs and command
  const mainCard = {
    // title: "Tool Tip",
